package com.fanniemae.innovation.monitoring.application;
...
@ComponentScan(basePackages= { "com.fanniemae.innovation"})
public class Boot2MetricsApplication {
	@Bean
	...
	public static void main(String[] args) {
		SpringApplication.run(Boot2MetricsApplication.class, args);
	}
}
